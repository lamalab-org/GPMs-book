...
% Editorial request environments (separate counter)
\newcounter{editorialrequest}
\setcounter{editorialrequest}{0}

\newenvironment{editorialpoint}
   {\refstepcounter{editorialrequest} \bigskip \noindent {\textbf{Editorial~Request~\arabic{editorialrequest}} } ---\ }
   {\par }

\newcommand{\shorteditorialpoint}[1]{\refstepcounter{editorialrequest}  \bigskip \noindent
    {\textbf{Editorial~Request~\arabic{editorialrequest}} } ---~#1\par }

\makeatletter
\newenvironment{editorialreply}
   {\medskip \noindent \color{coolblack} \textbf{Reply}:\ \itshape
    \protected@edef\@currentlabel{Editorial Request \arabic{editorialrequest}}%
    \def\cref@currentlabel{[editorialrequest][\arabic{editorialrequest}][]Editorial Request \arabic{editorialrequest}}}
   {\medskip }
\makeatother

\makeatletter
\newcommand{\shorteditorialreply}[2][]{%
    \protected@edef\@currentlabel{Editorial Request \arabic{editorialrequest}}%
    \def\cref@currentlabel{[editorialrequest][\arabic{editorialrequest}][]Editorial Request \arabic{editorialrequest}}%
    \medskip \noindent \textcolor{coolblack}{\textbf{Reply}:\  #2
    \ifthenelse{\equal{#1}{}}{}{ \hfill \footnotesize (#1)}}%
