...
acronym-form="plural+short"}, specialized representations like `MOFid`
...
[llm]{acronym-label="llm" acronym-form="singular+short"}, also
incorporated [smiles]{acronym-label="smiles"
acronym-form="singular+short"} into its training. Later, the
...
[moe]{acronym-label="moe" acronym-form="singular+short"} architecture
...
acronym-form="singular+short"} model (`Mol-MVMoE`
...
acronym-form="singular+short"} for querying chemical databases like
