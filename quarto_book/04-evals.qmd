...
<img src="media/figures/rescaled_figures/chemrev_figure8.png" width="100%" />
...
<img src="media/figures/final_figures/chembench_scoring.png" width="100%" />
<figcaption> <strong>[@mirza2024large] rankings based on different
scoring metrics</strong>: All metrics are a sum, weighted sum, or
maximum values over all <span data-acronym-label="mcq"
...
<img src="media/figures/rescaled_figures/chemrev_figure10.png" width="100%" />
...
Classical benchmarks such as \[@wu2018moleculenet\] typically target
molecular properties---such as solubility or binding affinity---that are
experimentally measurable and representationally grounded. However,
their evaluation setup, which relies on static and narrowly defined
datasets, often fails to capture real-world applicability.
...
implemented in , where $20\%$ of the questions are held out to safeguard
against data leakage and overfitting.\[@laurent2024lab0bench0\]
Alternatively, some initiatives explore privacy-preserving methods or
the use of trusted third parties to evaluate models on held-out data
without releasing it publicly. \[@eleutherai2024thirdparty\] Another
strategy is to regularly update benchmarks by introducing more difficult
or diverse tasks over time. \[@jimenez2023swe\] While this helps reduce
overfitting by continually challenging models, it complicates long-term
comparisons across versions and can undermine stability in performance
tracking. \[@alampara2025lessons\]
...
real-world settings. addresses this by allowing models to abstain via an
"insufficient information" option, enabling a more nuanced assessment
that distinguishes between confident knowledge and uncertainty.
...
Technical Report \[@openai2023gpt04\]. By augmenting with tools like
molecule search, synthesis planning, literature retrieval, and
purchasability checks, red-teamers were able to identify purchasable
chemical analogs of a given compound, and even managed to have one
delivered to a home address. While the demonstration used a benign
leukemia drug, the same approach could, in principle, be applied to
identify alternatives to harmful substances.\[@urbina2022dual\]
...
performance in multimodal chemistry tasks. In , they showed that
removing scientific terms or adding explicit guidance substantially
