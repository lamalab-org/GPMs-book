---
title: "Implications of GPMs: Education, Safety, and Ethics"
---

# Implications of GPMs: Education, Safety, and Ethics {#sec:implications}

The advent of [gpms]{acronym-label="gpm" acronym-form="plural+short"} in
...
integration of [gpms]{acronym-label="gpm" acronym-form="plural+short"}
...
[gpms]{acronym-label="gpm" acronym-form="plural+short"} are opening up
...
evaluations, and improve accessibility. [gpms]{acronym-label="gpm"
acronym-form="plural+short"} can support both students and educators at
...
For students, [gpms]{acronym-label="gpm" acronym-form="plural+short"}
...
<img src="media/figures/rescaled_figures/chemrev_figure23.png" width="100%" />
...
chemical education.</strong> <span data-acronym-label="gpm"
data-acronym-form="plural+short">gpms</span> can be used by students as
scientific assistants (e.g., for data analysis, coding or lab
experiments) and tutors (e.g., for question answering, teaching or
exercises). Teachers can use <span data-acronym-label="gpm"
data-acronym-form="plural+short">gpms</span> for evaluation (e.g., for
...
concerns.\[@Du2024\] Coupled with [ar]{acronym-label="ar"
acronym-form="singular+short"}, [gpms]{acronym-label="gpm"
acronym-form="plural+short"} could also enable immersive simulations of
...
At the same time, [gpms]{acronym-label="gpm"
acronym-form="plural+short"} could ease the workload of educators. They
...
Despite these envisioned potentials of [gpms]{acronym-label="gpm"
acronym-form="plural+short"} in chemistry education, current
...
[llms]{acronym-label="llm" acronym-form="plural+short"} or
[vlms]{acronym-label="vlm" acronym-form="plural+short"} to aid with
...
state-of-the-art [vlms]{acronym-label="vlm"
acronym-form="plural+short"}, including and , struggled to assess
student reasoning and correctness, particularly in open-ended or
diagram-based answers. Similarly, @Kortemeyer2024 investigated the use
of for grading handwritten thermodynamics exams at . While the model
performed reasonably well on short derivations, it failed to track
detailed rubrics or interpret hand-drawn diagrams reliably. In chemistry
education, @kharchenko2024advantages compared , , and on
domain-specific tasks and found that while the models performed
adequately on simple recall questions, they failed in tasks that
required chemical reasoning, structural understanding, or logical
analysis.

Together, these findings suggest that while zero-shot prompting enables
rapid deployment of [gpms]{acronym-label="gpm"
acronym-form="plural+short"} in educational contexts, current models
...
A growing number of applications embed [gpms]{acronym-label="gpm"
acronym-form="plural+short"} in specialized educational systems that
combine [gpms]{acronym-label="gpm" acronym-form="plural+short"} with
structured components such as [rag]{acronym-label="rag"
acronym-form="singular+short"}, tracking learning progress, or the
...
[qa]{acronym-label="qa" acronym-form="singular+short"} system that used
a [rag]{acronym-label="rag" acronym-form="singular+short"} pipeline to
...
illustrate the potential of structured [gpm]{acronym-label="gpm"
acronym-form="singular+short"}-based learning environments, fully
...
responses. Although [gpms]{acronym-label="gpm"
acronym-form="plural+short"} produce fluent and plausible explanations,
...
competence. In such cases, [gpms]{acronym-label="gpm"
acronym-form="plural+short"} can disrupt the connection between concrete
...
increasingly use [gpms]{acronym-label="gpm"
acronym-form="plural+short"}, both in education and in their future
...
perhaps especially---in the age of [gpms]{acronym-label="gpm"
acronym-form="plural+short"}. \[@klein2025rethink\]

## Safety {#sec:safety}

<figure id="fig:safety-overview">
<img src="media/figures/safety_chemrev_fig.png" width="100%" />
...
encountering <span data-acronym-label="ai"
data-acronym-form="singular+short">ai</span> exacerbated risks. The path
to superaligned chemical <span data-acronym-label="ai"
data-acronym-form="singular+short">ai</span>-assistants is obfuscated by
unexplored chemical space.</figcaption>
</figure>

A growing coalition within the scientific community has sounded a call
to action: [ai]{acronym-label="ai" acronym-form="singular+short"} poses
...
statement signed by hundreds of prominent [ai]{acronym-label="ai"
acronym-form="singular+short"} researchers, reflects mounting
recognition that advanced [ai]{acronym-label="ai"
acronym-form="singular+short"} systems could fundamentally alter, or
threaten, human civilization. While the ongoing discourse has focused on
abstract notions of [agi]{acronym-label="agi"
acronym-form="singular+short"}, the immediate risks may emerge through
the integration of [ai]{acronym-label="ai"
acronym-form="singular+short"} into specific domains where the stakes
are already high \[@morris2023levels\].

Chemistry represents one such domain. The rapid integration of
[gpms]{acronym-label="gpm" acronym-form="plural+short"} in chemistry is
...
of dangerous compounds, [ai]{acronym-label="ai"
acronym-form="singular+short"} systems could lower barriers for misuse,
whether intentional or accidental. [gpms]{acronym-label="gpm"
acronym-form="plural+short"} alone may not create new risks
...
[ai]{acronym-label="ai" acronym-form="singular+short"} outputs and
...
A critical question is whether [llms]{acronym-label="llm"
acronym-form="plural+short"} provide maliciously acting novices with new
avenues to obtain harmful knowledge beyond what is already easily
accessible (e.g., via the internet)\[@sandbrink2023artificial\].
Preliminary research has explored whether [llms]{acronym-label="llm"
acronym-form="plural+short"} can exacerbate biorisks, a concern that
...
de novo molecular generator, , could be used to design toxic chemical
agents by adjusting the reward system of the model to prefer compounds
with greater toxicity and bioactivity. While their model predicted VX
(toxic nerve agent) and other chemical warfare agents, the actual
synthesis of such compounds requires expertise, controlled precursors,
and specialized equipment that is far beyond the capabilities of most
non-state actors.

Recent evaluations by and have systematically assessed how their models
can facilitate the creation of biological threats. In an evaluation of
their Deep Research System (a multi-agent architecture), classified the
system to be medium-risk for chemical and biological threat-creation.
\[@openai2024building\] As discussed previously, a key barrier that
prevents such models from exceeding the assessed risk threshold is the
acquisition of "tacit knowledge". However, this system demonstrated
modest improvements in troubleshooting and the acquisition of tacit
knowledge. Although it still fell short of expert-level performance,
these findings suggest that models are making progress toward overcoming
this critical hurdle. They also evaluated 's impact on experts and
students across five biological threat creation stages: ideation,
acquisition, magnification, formulation, and release.
\[@openai2024building\] Their key finding was that biorisk information
is widely accessible without [ai]{acronym-label="ai"
acronym-form="singular+short"} and that practical constraints such as
wet lab access or domain expertise are more limiting than information
scarcity.

's parallel assessment of focused specifically on biological risks
through red-teaming with bio-defense experts, multi-step agentic
evaluations, and explicit testing of bioinformatics tool integration
\[@anthropic2025system\]. Their findings align with 's assessment of ,
and conclude that current systems remain constrained by physical
barriers. Both studies emphasize that supply chain control of chemicals,
the flow of goods (e.g., chemical reagents) from suppliers to consumers,
remains crucial as these systems continue to evolve and barriers to
accessing knowledge are continuously lowered. For example, although
@he2023control showed that [llms]{acronym-label="llm"
acronym-form="plural+short"} can generate pathways for explosives like
[petn]{acronym-label="petn" acronym-form="singular+short"} or nerve
agents like sarin, the supply chain of obtaining precursor chemicals for
weapons like sarin is tightly regulated. In addition, access to lab
infrastructure like fume hoods or inert environments is not trivial to
obtain for non-experts.
...
accessing materials are not an argument for [ai]{acronym-label="ai"
acronym-form="singular+short"} complacency. Models that lower the
...
Another critical risk of [gpms]{acronym-label="gpm"
acronym-form="plural+short"} is their propensity for hallucination,
...
protocols. Additionally, [llms]{acronym-label="llm"
acronym-form="plural+short"} suffer from temporal misalignment; their
...
[ai]{acronym-label="ai" acronym-form="singular+short"} systems are
...
[ai]{acronym-label="ai" acronym-form="singular+short"} systems capable
...
evaluating the safety of [ai]{acronym-label="ai"
acronym-form="singular+short"} systems, even in the chemical domain (see
[\[sec:evals\]](#sec:evals){reference-type="ref+Label"
reference="sec:evals"}). While such evaluations are valuable to identify
weaknesses in [gpms]{acronym-label="gpm" acronym-form="plural+short"},
...
[gpms]{acronym-label="gpm" acronym-form="plural+short"}, which must
...
[rlhf]{acronym-label="rlhf" acronym-form="singular+short"} or
Constitutional [ai]{acronym-label="ai" acronym-form="singular+short"}
...
In an effort to train trustworthy models, many [ai]{acronym-label="ai"
acronym-form="singular+short"} researchers have turned to
"interpretability", an approach that aims to explain how the
computations [gpms]{acronym-label="gpm" acronym-form="plural+short"} are
linked to the output. \[@cunningham2023sparse\] However, in a recent
global evaluation of [ai]{acronym-label="ai"
acronym-form="singular+short"} safety, @bengio2025international argue
that [sota]{acronym-label="sota" acronym-form="singular+short"}
...
Even chemistry-specific [llms]{acronym-label="llm"
acronym-form="plural+short"} agents like \[@bran2024augmenting\] or
\[@boiko2023autonomous\] exhibit vulnerabilities. For instance, 's
safeguards block known controlled substances, yet @he2023control
demonstrated a flaw in its safety protocols. The agent's refusals are
reactive rather than proactive, as they rely on post-query web search
checks rather than embedded safeguards.

The capabilities and ensuing risks posed by [gpms]{acronym-label="gpm"
acronym-form="plural+short"} need to be contextualized around user
...
The gaps in current [ai]{acronym-label="ai"
acronym-form="singular+short"} safety measures reveal a pressing need
for proactive frameworks that address technical and systemic risks.
\[@bengio2025international\]

#### Regulatory Framework for Chemical [ai]{acronym-label="ai" acronym-form="singular+short"} Models

Drawing from emerging biosecurity governance models, as a first step,
chemical [ai]{acronym-label="ai" acronym-form="singular+short"}
...
[ai]{acronym-label="ai" acronym-form="singular+short"} models because it
...
[ai]{acronym-label="ai" acronym-form="singular+short"} safety concerns.
The US [ai]{acronym-label="ai" acronym-form="singular+short"} Safety
Institute \[@nist2024safety\] and the UK [ai]{acronym-label="ai"
acronym-form="singular+short"} Safety Institute have been tasked with
designing safety evaluations for frontier models and researching
catastrophic risks from [ai]{acronym-label="ai"
acronym-form="singular+short"} systems. In contrast, the
[eu]{acronym-label="eu" acronym-form="singular+short"} has taken a more
pragmatic regulatory approach through the [eu]{acronym-label="eu"
acronym-form="singular+short"} [ai]{acronym-label="ai"
acronym-form="singular+short"} Act \[@EU2024regulation\], which
classifies [ai]{acronym-label="ai" acronym-form="singular+short"}
...
While more comprehensive in scope, the [eu]{acronym-label="eu"
acronym-form="singular+short"} [ai]{acronym-label="ai"
acronym-form="singular+short"} Act focuses primarily on general
[ai]{acronym-label="ai" acronym-form="singular+short"} applications
...
dual-use nature of chemical [ai]{acronym-label="ai"
acronym-form="singular+short"} models.

#### Future Institutional Oversight and Transparency

A critical step forward is establishing neutral and independent
regulatory bodies to oversee [ai]{acronym-label="ai"
acronym-form="singular+short"} development. Unlike self-regulation,
which risks conflicts of interest, an [iaio]{acronym-label="iaio"
acronym-form="singular+short"} comprised of [ai]{acronym-label="ai"
acronym-form="singular+short"} researchers, policymakers, ethicists, and
...
could mandate pre-approval for high-risk [ai]{acronym-label="ai"
acronym-form="singular+short"} research (like [agi]{acronym-label="agi"
acronym-form="singular+short"}-aligned projects), similar to
institutional review boards that exist in the biomedical research space
\[@pistono2016unethical\]. Precedents for this exist in
[cern]{acronym-label="cern" acronym-form="singular+short"}, which tries
...
market access, where [ai]{acronym-label="ai"
acronym-form="singular+short"} products and precursors can only be
traded internationally if certified by the [iaio]{acronym-label="iaio"
acronym-form="singular+short"}. Participating states would then enact
...
[ai]{acronym-label="ai" acronym-form="singular+short"} developers should
...
The risks posed by [ai]{acronym-label="ai"
acronym-form="singular+short"} in chemistry demand immediate action from
governments and institutions. Yet these challenges also invite a deeper
question: *Is the integration of [ai]{acronym-label="ai"
acronym-form="singular+short"} into scientific discovery fundamentally
advancing our understanding or merely accelerating the production of
epistemic noise?* As @narayanan2025why cautioned,
[ai]{acronym-label="ai" acronym-form="singular+short"}'s predictive
abilities often obscure its inability to explain underlying mechanisms.
In chemistry, this tension is acute: [ai]{acronym-label="ai"
acronym-form="singular+short"}-driven tools may optimize reactions or
...
[ai]{acronym-label="ai" acronym-form="singular+short"}'s role in science
should be expansive or deliberately constrained.

## Ethics {#sec:ethics}

The deployment of [gpms]{acronym-label="gpm"
acronym-form="plural+short"} in the chemical sciences raises several
...
[gpms]{acronym-label="gpm" acronym-form="plural+short"} contribute to
...
change. \[@strubell2019energy\] The emphasis on [ai]{acronym-label="ai"
acronym-form="singular+short"} research has superseded some of the
...
surge in [ai]{acronym-label="ai" acronym-form="singular+short"} usage
...
questions about the sustainability of current [ai]{acronym-label="ai"
acronym-form="singular+short"} development trajectories and consider
...
[gpms]{acronym-label="gpm" acronym-form="plural+short"} are typically
...
[ai]{acronym-label="ai" acronym-form="singular+short"}*, where
plaintiffs allege unauthorized scraping of protected content.
\[@kirchhubel2024intellectual\] Developers at claimed in a statement to
the [uk]{acronym-label="uk" acronym-form="singular+short"} House of
Lords that training [sota]{acronym-label="sota"
acronym-form="singular+short"} models is "impossible" without
copyrighted material, highlighting a fundamental tension between
[ip]{acronym-label="ip" acronym-form="singular+short"} law and
[ai]{acronym-label="ai" acronym-form="singular+short"} advancement.
...
the [cas]{acronym-label="cas" acronym-form="singular+short"} Common
Chemistry database provide legally clear training data while maintaining
attribution. [llms]{acronym-label="llm" acronym-form="plural+short"}
...
[gpms]{acronym-label="gpm" acronym-form="plural+short"} for overcoming
...
[gpms]{acronym-label="gpm" acronym-form="plural+short"} inherit and
...
treatments, and [gpms]{acronym-label="gpm" acronym-form="plural+short"}
...
mandated prior to deployment of [gpms]{acronym-label="gpm"
acronym-form="plural+short"}.

### Democratization of Power

Although [ai]{acronym-label="ai" acronym-form="singular+short"} tools
