...
One of our major use-cases: writing, improving, and reviewing code using LLMs.  
...
You can see some examples for issues [in](https://blog.vidocsecurity.com/blog/vibe-coding-security-vulnerabilities) [various](https://www.databricks.com/blog/passing-security-vibe-check-dangers-vibe-coding) [blog posts](https://hackaday.com/2025/04/12/vibe-check-false-packages-a-new-llm-security-risk/). 
It even goes so far that API endpoints are disclosed in client site code or that attacters might attempt to figure out what packages LLMs hallucinate to then use those hallucinated packages as attack vectors.
